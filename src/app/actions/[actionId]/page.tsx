                  ...
                  <div className="bg-white rounded-xl border border-purple-200 p-4 space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        >
                          <option value="dsc-token-01">Authorized Signatory (DIN / DSC) - Class 3 Certificate</option>
                          <option value="dsc-token-02">Practicing Professional (CA / CS) - Class 3 Certificate</option>
                        </select>
                      </div>
